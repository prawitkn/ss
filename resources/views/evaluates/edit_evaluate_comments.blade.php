...
@section('content')
   ...
   <div class="row">
        <div class="col-md-12">
            ...
            <div class="card">
                <form  id="form1" class="form-horizontal" method="post" action="{{ url('/evaluates/save-evaluate-comments') }}" 
     novalidate="novalidate" >{{ csrf_field() }}
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <a href="{{ url('/evaluates/edit-evaluate/'.$evaluate_headers->id).'/'.$topicGroup->id.'/'.$evaluator->id }}" class="btn btn-outline-success" >{{ $topicGroup->id.'. '.$topicGroup->topic_group_name }} </a>&nbsp;
                            @break;
                            @case(4) 
                        <a href="{{ url('/evaluates/edit-evaluate-timeAttendance/'.$evaluate_headers->id).'/'.$topicGroup->id.'/'.$evaluator->id }}" class="btn btn-outline-success" >{{ $topicGroup->id.'. '.$topicGroup->topic_group_name }} </a>&nbsp;
                            @break;
                        @endswitch
                        @endforeach
                        <a href="{{ url('/evaluates/edit-evaluate-comments/'.$evaluate_headers->id).'/'.$topicGroup->id.'/'.$evaluator->id }}" class="btn btn-success" > บันทึกความคิดเห็น </a>&nbsp;
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            <label for="comment1" class="text-right control-label col-form-label">จุดแข็งของผู้รับการประเมิน : </label>
                                <div class="">
                                    <textarea name="comment1" id="comment1" class="form-control" placeholder="..."></textarea>
                                </div>
                        </div>
                        <!--/.col-sm-4-->
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                <label for="comment2" class="text-right control-label col-form-label">จุดอ่อนของผู้รับการประเมิน : </label>
                                <div class="">
                                    <textarea name="comment2" id="comment2" class="form-control" placeholder="..."></textarea>
                                </div>
                            </div>
                        </div>
                        <!--/.col-sm-4-->
                        ...
                        <div class="col-sm-4">
                                <label for="comment3" class="text-right control-label col-form-label">การส่งเสริมทักษะการทำงาน : </label>
                                <div class="">
                                    <textarea name="comment3" id="comment3" class="form-control" placeholder="..."></textarea>
                                </div>
                        </div>
                        <!--/.col-sm-4-->
