...
@section('content')
                ...
                <div class="ml-auto text-right">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page"> เพิ่มหัวข้อการประเมิน (ตำแหน่ง/รายบุคคล)</li>
                        </ol>
                    </nav>
                </div>
            </div>
   ...
   <div class="row">
        <div class="col-md-12">
        	<div class="card">
                <form class="form-horizontal" method="post" action="{{ url('/topics/add-topic-by-one') }}" novalidate="novalidate" >{{ csrf_field() }}
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-3">
                                ...
                                <a href="#" name="searchEmployeeCode" data-id="" class="btn btn-outline-primary"> ค้นหา</a>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <textarea name="topic_name" id="topic_name" class="form-control" placeholder="หัวข้อการประเมิน..."></textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <textarea name="topic_desc" id="topic_desc" class="form-control" placeholder="เป้าหมายที่ใช้ประเมิน (KPI)..."></textarea>
                            </div>
                        </div>
                        
                    <div class="border-top">
                        <div class="card-body">
                            <button type="submit" class="btn btn-primary"> เพิ่มหัวข้อการประเมิน (ตำแหน่ง/รายบุคคล)</button>
                        </div>
                    </div>
                </form>
            </div>
