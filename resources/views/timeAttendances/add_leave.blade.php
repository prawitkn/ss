     ...
     <div class="page-breadcrumb">
        <div class="row">
            <div class="col-12 d-flex no-block align-items-center">
                <h3 class="page-title">เวลาการลาป่วย/ลากิจ</h3>
                <div class="ml-auto text-right">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">เพิ่มเวลาการลาป่วย/ลากิจ</li>
                        </ol>
                    </nav>
                </div>
            </div>
        ...
        <div class="col-md-12">
        	...
        	<div class="card">
                ...
                <div class="card-body">
                    ...
                    <form class="" enctype="multipart/form-data" method="post" action="{{ url('/timeAttendances/use-leave') }}" novalidate="novalidate" >{{ csrf_field() }}
