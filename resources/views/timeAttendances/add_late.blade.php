...
@section('content')
     ...
     <div class="page-breadcrumb">
        <div class="row">
            <div class="col-12 d-flex no-block align-items-center">
                <h3 class="page-title">การเข้าสาย-กลับก่อน</h3>
                <div class="ml-auto text-right">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">เพิ่มการเข้าสาย-กลับก่อน</li>
                        </ol>
                    </nav>
                </div>
            </div>
   ...
   <div class="row">
        <div class="col-md-12">
        	...
        	<div class="card">
                <form class="" enctype="multipart/form-data" method="post" action="{{ url('/timeAttendances/add-late') }}" novalidate="novalidate" >{{ csrf_field() }}
                ...
                <div class="card-body">
                    ...
                    <form class="" enctype="multipart/form-data" method="post" action="{{ url('/timeAttendances/use-late') }}" novalidate="novalidate" >{{ csrf_field() }}
